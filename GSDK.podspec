#
#  Be sure to run `pod spec lint libGSDK.podspec' to ensure this is a
...
这是一个基于佳博打印系列的iOS打印SDK
  ...
  # Or just: spec.author    = "chenzijian"
  # spec.authors            = { "chenzijian" => "1195688960@qq.com" }
  # spec.social_media_url   = "https://twitter.com/chenzijian"
  ...
  spec.source_files  = "GSDK/Classes/**/*"
